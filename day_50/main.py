...
password = driver.find_element(By.CSS_SELECTOR, '//*[@id="pass"]')
...
for n in range(100):
    ...
    try:
        print("called")
        like_button = driver.find_element(By.XPATH, '//*[@id="content"]/div/div[1]'
                                                    '/div/main/div[1]/div/div/div[1]/div/div[2]/div[4]/button')
        like_button.click()
